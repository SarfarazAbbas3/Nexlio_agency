...
const faqs = [
  {
    ...
    answer:
      "Branding costs depend on your business goals, project scope, and required deliverables. Contact Nexlio for a customized quote.",
  },
  {
    question: "How long does a branding project take?",
    answer:
      "Most branding projects are completed within 1 to 3 weeks depending on the complexity.",
  },
  {
    question: "What is included in your branding service?",
    answer:
      "Our branding services include logo design, brand identity, typography, color palette, brand guidelines, and social media branding assets.",
  },
  {
    question: "Can you redesign an existing brand?",
    answer:
      "Yes. We can modernize your existing brand while maintaining its identity and improving its professional appearance.",
  },
  {
    question: "Why is branding important for a business?",
    answer:
      "Strong branding builds trust, improves recognition, differentiates your business from competitors, and helps attract more customers.",
  },
];
